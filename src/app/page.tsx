...
// Type and spacing here follow the approved design reference (an exported
// design-canvas mockup a previous contributor shared) — colours now come from
// the app-wide tokens in globals.css instead of being hardcoded to that
// reference's dark values, so this page follows the theme toggle too.

// Step badges reuse the participant-avatar colours: they're the same three
// accent tones, and they already have a light-mode-safe variant.
const steps = [
  {
    number: 1,
      ...
      <div className="mx-auto max-w-6xl px-6 pb-16 sm:px-10 sm:pb-20 lg:px-14">
        ...
        <div className="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-12 lg:items-center lg:gap-10">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="mt-4 text-center text-sm text-ink-muted">
              ...
              <Link href="/recovery" className="text-accent-ink underline">
        ...
        <div className="mt-20 sm:mt-24 lg:mt-28">
          ...
          <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-3">
            {steps.map((step) => (
              <div key={step.number} className="flex flex-col gap-5 rounded-[26px] border border-line bg-surface p-7">
