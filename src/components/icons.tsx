/*
 * Shared line icons, previously scattered inline across components. All
 * stroke `currentColor` so the colour comes from whatever token the parent
 * sets — never hardcode a stroke color when using these.
 */
...
/** Half-filled circle — the theme control's "follow OS" state. */
