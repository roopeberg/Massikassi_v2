...
/**
 * The round control in the artboard's nav. Three states: follow the OS (the
 * default), force light, force dark. "Follow the OS" stays reachable by
 * cycling — a two-state toggle would quietly lock the reader out of it after
 * the first click.
 *
...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex h-11 w-11 items-center justify-center rounded-full border border-line bg-surface-2 text-ink-soft transition-colors hover:text-ink"
    >
